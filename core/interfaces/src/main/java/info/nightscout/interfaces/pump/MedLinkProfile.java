package info.nightscout.interfaces.pump;//package info.nightscout.androidaps.data;
//
...
//    }
//
//    @NonNull @Override public ValidityCheck isValid(@NonNull String from, @NonNull Pump pump, @NonNull Config config, @NonNull ResourceHelper rh, @NonNull RxBus rxBus, @NonNull HardLimits hardLimits, boolean sendNotifications) {
//        return null;
//    }
//
