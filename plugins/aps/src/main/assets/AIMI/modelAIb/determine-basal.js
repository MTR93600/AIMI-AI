...
var TimeSMB = round(( new Date(systemTime).getTime() - meal_data.lastBolusSMBTime ) / 60000,1);
    ...
    if (eventualBG < min_bg) { // if eventual BG is below target:
        ...
        var lastpredValues = now.getHours() < 11 ? UAMpredBGs.slice(-8) : UAMpredBGs.slice(-4);
    ...
    if (iob_data.iob > max_iob) {
        ...
        if (microBolusAllowed && enableSMB && bg > threshold) { //#MT AIMI
            ...
            AIMI_UAM_CAP *= 0.7;
            }else if (circadian_smb < -3 && lastbolusAge > profile.key_mbi){
            ...
            if (!profile.temptargetSet && delta > 0) {
                ...
                if ((meal_data.MaxSMBcount >= 1 || meal_data.countSMB40 > 2 || meal_data.countSMB40 === 0) && lastbolusAge > profile.key_mbi){
                    var M1 = microBolus / 3;
                    var M2 = microBolus / 2;
                    var nosmb;
        ...
        // if insulinReq > 0 but not enough for a microBolus, don't set an SMB zero temp
            ...
            if (profile.key_use_countsteps === true && profile.recentSteps30Minutes > 900 && profile.recentSteps5Minutes >= 0 && profile.accelerating_up === 0 && lastbolusAge > profile.key_mbi){
            SMBInterval = 15;
        ...
        else if (!aimi_activity && delta > 0 && profile.tddlastHrs !== null && profile.tdd7DaysPerHour !== null && profile.tddlastHrs < profile.tdd7DaysPerHour && UAMpredBG > profile.key_UAMpredBG) {
