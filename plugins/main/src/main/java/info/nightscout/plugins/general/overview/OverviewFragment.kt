...
class OverviewFragment : DaggerFragment(), View.OnClickListener, OnLongClickListener {
    ...
    private fun processButtonsVisibility() {
        ...
        runOnUiThread {
            _binding ?: return@runOnUiThread
            if (showAcceptButton && pump.isInitialized() && (!pump.isSuspended() && pump !is MedLinkPumpPluginBase) && (loop as PluginBase).isEnabled()) {
            ...
            binding.buttonsLayout.treatmentButton.visibility = (!loop.isDisconnected && pump.isInitialized() && (!pump.isSuspended() || pump is MedLinkPumpPluginBase
                ) && profile != null
                && sp.getBoolean(R.string.key_show_treatment_button, false)).toVisibility()
            binding.buttonsLayout.wizardButton.visibility = (!loop.isDisconnected && pump.isInitialized() && (!pump.isSuspended() || pump is MedLinkPumpPluginBase
                ) && profile != null
                && sp.getBoolean(R.string.key_show_wizard_button, true)).toVisibility()
            binding.buttonsLayout.insulinButton.visibility = (!loop.isDisconnected && pump.isInitialized() && (!pump.isSuspended() || pump is MedLinkPumpPluginBase
                ) && profile != null
