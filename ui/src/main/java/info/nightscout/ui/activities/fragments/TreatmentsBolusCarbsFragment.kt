...
class TreatmentsBolusCarbsFragment : DaggerFragment(), MenuProvider {
    ...
    override fun onCreateMenu(menu: Menu, inflater: MenuInflater) {
        ...
        val nsUploadOnly =
            !sp.getBoolean(info.nightscout.core.utils.R.string.key_ns_receive_insulin, false) || !sp.getBoolean(info.nightscout.core.utils.R.string.key_ns_receive_carbs,
                                                                                                                false) || !config.isEngineeringMode()
