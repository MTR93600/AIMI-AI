...
@Singleton
public class MedLinkMedtronicHistoryData {
    ...
    @Inject
    public MedLinkMedtronicHistoryData(
...
//            }
    ...
    public void processLastBasalProfileChange(PumpType pumpType, MedLinkMedtronicPumpStatus mdtPumpStatus) {
