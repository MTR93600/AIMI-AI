...
public class MedLinkStatusActivity extends NoSplashAppCompatActivity {
    ...
    public void refreshData(int position) {
        if (position == 0) {
            // FIXME i18n
            this.connectionStatus.setText(medLinkServiceData.rileyLinkServiceState.name());
            this.configuredAddress.setText(medLinkServiceData.rileylinkAddress);
            // FIXME
            this.connectedDevice.setText("???");
            // FIXME i18n
            this.connectionError.setText(medLinkServiceData.rileyLinkError.name());
        } else {
    ...
    public void setupViewPager(ViewPager pager) {
        ...
        mSectionsPagerAdapter.addFragment(new MedLinkStatusGeneralFragment(), resourceHelper.gs(R.string.rileylink_settings_tab1));
        mSectionsPagerAdapter.addFragment(new MedLinkStatusHistoryFragment(), resourceHelper.gs(R.string.rileylink_settings_tab2));
