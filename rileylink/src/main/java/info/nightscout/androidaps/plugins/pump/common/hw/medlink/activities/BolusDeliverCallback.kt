 ...
 */
class BolusDeliverCallback (val pumpStatus: MedLinkPumpStatus, val plugin: MedLinkPumpPluginAbstract, val aapsLogger: AAPSLogger) : BaseStringAggregatorCallback() {
