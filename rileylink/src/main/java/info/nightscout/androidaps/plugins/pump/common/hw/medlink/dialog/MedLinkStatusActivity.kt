...
class MedLinkStatusActivity : NoSplashAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sectionsPagerAdapter?.addFragment(MedLinkStatusGeneralFragment::class.java.name, rh.gs(R.string.rileylink_settings_tab1))
        sectionsPagerAdapter?.addFragment(MedLinkStatusHistoryFragment::class.java.name, rh.gs(R.string.rileylink_settings_tab2))
