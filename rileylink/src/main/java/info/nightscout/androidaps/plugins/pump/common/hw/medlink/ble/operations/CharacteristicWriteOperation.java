 ...
 * copied from @{link {@link info.nightscout.androidaps.plugins.pump.common.hw.rileylink.ble.operations.CharacteristicWriteOperation}}
 */
public class CharacteristicWriteOperation extends BLECommOperation {
    ...
    public void execute(MedLinkBLE comm) {
        aapsLogger.info(LTag.PUMPBTCOMM, "execute write characteristic");
