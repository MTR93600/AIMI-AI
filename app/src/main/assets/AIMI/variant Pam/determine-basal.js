...
if (AIMI_UAM && AIMI_BreakFastLight && now >= AIMI_BL_StartTime && now <= AIMI_BL_EndTime){
    ...
    console.log("*****Future_sens is not use with light breakfast");
                ...
                console.error("\n");
                console.log("--------------");
                console.log(" AAPS-3.1.0.3-dev-b-AIMI V22b 19/10/2022 Variant Pam ");
                console.log("--------------");
                if ( meal_data.TDDAIMI3 ){
    ...
    rT.reason += "\nDEVb-AIMI-V22b-Variant VariantPam-19/10/22 ";
    rT.reason += "; ";
    ...
    if ( meal_data.TDDAIMI3 ){
       ...
       if (iTimeActivation === true){
            ...
            SMBInterval = 20;
            }else if (iTimeActivation && meal_data.lastBolusSMBUnits > 0.6 * AIMI_UAM_CAP || iTimeActivation && countSMB > 2){
            SMBInterval = 10;
