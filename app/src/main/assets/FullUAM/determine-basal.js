...
if (AIMI_UAM && AIMI_BreakFastLight && now >= AIMI_BL_StartTime && now <= AIMI_BL_EndTime){
    ...
    console.log("*****Future_sens is not use with light breakfast");
        ...
        console.log("------------------------------");
                console.log(" AAPS-Master-3.0.1-autotune-dev-i-AIMI V17 10/05/2022 ");
                console.log("------------------------------");
                if ( meal_data.TDDAIMI3 ){
                console.log(enlog);
                }
    ...
    if ( meal_data.TDDAIMI3 ){
        ...
        console.log("------------------------------");
            ...
            if (TriggerPredSMB_future_sens_60 < 85 && AIMI_UAM_Fiasp){
            microBolus = 0;
            UAMAIMIReason += ", No SMB beacuase Fiasp and Pred < 85, ";
