...
//**********************************************************************************************************************************************
        ...
        this.mealData.put("currentTIRLow", StatTIR!!.averageTIR(StatTIR!!.calculateDaily(65.0, 160.0)).belowPct())
        this.mealData.put("currentTIRRange", StatTIR!!.averageTIR(StatTIR!!.calculateDaily(65.0, 160.0)).inRangePct())
        this.mealData.put("currentTIRAbove", StatTIR!!.averageTIR(StatTIR!!.calculateDaily(65.0, 160.0)).abovePct())
