    ...
    inner class NotificationRecyclerViewAdapter internal constructor(private val notificationsList: List<Notification>) :
        ...
        override fun onBindViewHolder(holder: NotificationsViewHolder, position: Int) {
            ...
            when (notification.level) {
                Notification.URGENT -> holder.binding.cv.setBackgroundColor(rh.gac(context ,R.attr.notificationUrgent ))
                Notification.NORMAL -> holder.binding.cv.setBackgroundColor(rh.gac(context,R.attr.notificationNormal ))
                Notification.LOW -> holder.binding.cv.setBackgroundColor(rh.gac(context,R.attr.notificationLow ))
                Notification.INFO -> holder.binding.cv.setBackgroundColor(rh.gac(context,R.attr.notificationInfo ))
