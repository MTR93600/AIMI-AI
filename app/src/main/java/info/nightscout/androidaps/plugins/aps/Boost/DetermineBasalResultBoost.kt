...
class DetermineBasalResultBoost private constructor(injector: HasAndroidInjector) : APSResult(injector) {
    ...
    override fun newAndClone(injector: HasAndroidInjector): DetermineBasalResultBoost {
        val newResult = DetermineBasalResultBoost(injector)
        doClone(newResult)
