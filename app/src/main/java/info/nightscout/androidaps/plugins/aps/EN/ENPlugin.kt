...
open class ENPlugin @Inject constructor(
    ...
    var lastDetermineBasalAdapterENJS: DetermineBasalAdapterENJS? = null
    ...
    override fun invoke(initiator: String, tempBasalFallback: Boolean) {
        ...
        DetermineBasalAdapterENJS(ScriptReader(context), injector).also { determineBasalAdapterENJS ->
            determineBasalAdapterENJS.setData(profile, maxIob, maxBasal, minBg, maxBg, targetBg,
            ...
            if (determineBasalResultEN == null) {
                ...
                lastDetermineBasalAdapterENJS = null
                lastAPSResult = null
                lastAPSRun = 0
            } else {
                ...
                lastDetermineBasalAdapterENJS = determineBasalAdapterENJS
                lastAPSResult = determineBasalResultEN
                lastAPSRun = now
            }
        }
